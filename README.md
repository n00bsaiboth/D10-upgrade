create a folder called D10-upgrade
...
After the installation, you now might want to export the configs to git/github and commit all of the rest changes that you have made. Enjoy your day and have a cup of tee, because you just upgraded Drupal. 